...
if __name__ == '__main__':
    # path = '/home/avalanche/Downloads/refinedDataForRPQ/LUBM300/regexes'
    # files = [file for file in listdir(path) if isfile(join(path, file))]
    iterations_num = 5
    input_dir_path = "/home/avalanche/Downloads/refinedDataForRPQ/"
    output_dir_path = "/home/avalanche/Desktop/Projects/python/spbu-gdb2020/src/output/"
    graph = Graph()
